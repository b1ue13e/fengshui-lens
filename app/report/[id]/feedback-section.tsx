...
export function FeedbackSection({ reportId }: FeedbackSectionProps) {
  ...
  return (
    <section className="paper-panel rounded-[1.8rem] p-6">
      ...
      <h3 className="mt-5 text-lg font-medium text-foreground">这份预筛报告帮到你了吗？</h3>
      <p className="mt-2 text-sm leading-7 text-muted-foreground">
        如果有判断不准、信息缺失或表述不够清楚的地方，告诉我们会很有价值。
      </p>
      ...
      <div className="mt-5 grid gap-3 sm:grid-cols-2">
        ...
        >
          ...
          />
          <div className="mt-3 text-sm font-medium text-foreground">不够准确</div>
          <p className="mt-1 text-sm leading-7 text-muted-foreground">
            有些判断和实际情况不一致，或结论还不够可信。
          </p>
        </button>
      </div>
