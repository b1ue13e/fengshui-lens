...
export default function AnalyzePage() {
  ...
  const handleViewFullReport = () => {
    ...
    localStorage.setItem('spacerisk_last_evaluation', JSON.stringify(payload));
    router.push('/result');
  };
