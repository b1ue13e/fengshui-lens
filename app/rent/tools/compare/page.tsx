...
import { Dimension, EngineResult, PrimaryGoal } from "@/lib/rent-tools/types";
...
const verdictConfig = {
  rent: { label: "可以继续了解", color: "bg-emerald-100 text-emerald-800", icon: CheckCircle2 },
  cautious: { label: "带着问题再核验", color: "bg-amber-100 text-amber-800", icon: AlertTriangle },
  avoid: { label: "先别急着租", color: "bg-red-100 text-red-800", icon: AlertTriangle },
};
    ...
    <div className="min-h-screen bg-stone-50 pb-20">
      ...
      <header className="border-b bg-white sticky top-0 z-50">
        <div className="max-w-3xl mx-auto px-4 h-14 flex items-center gap-4">
          <Link href="/rent/tools" className="text-stone-500 hover:text-stone-900">
